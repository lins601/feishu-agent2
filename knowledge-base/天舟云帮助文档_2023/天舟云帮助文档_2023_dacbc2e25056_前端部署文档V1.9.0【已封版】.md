...
source_url: https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0
normalized_url: https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0
url_hash: dacbc2e25056
document_key: 天舟云帮助文档_2023_dacbc2e25056
doc_id: tzv16-fe-1.9.0
title: 前端部署文档V1.9.0【已封版】
md_hash: 51714f3e8c4eef2b
version: 1685431314
image_count: 0
...
- [1. 没有部署过V1.6.0](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#d9o2pc)
- [1.1 代码仓库](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#f0zaw3)
- [1.2 代码分支](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#4ffucf)
- [1.3 Apollo配置](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#d0vd5m)
- [1.4 鲸云配置](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#793ojb)
- [2. 部署过V1.6.0，增量部署V1.9.0](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#4g4il0)
- [2.1 增加Apollo配置](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#gc94i0)
- [2.1.1 `tianzhou.api`](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#c96v1a)
- [2.1.2 `tianzhou.env`](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#7fz3wm)
- [2.2 业务系统接入修改（未接入业务系统则不做如下修改）](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#7wls)
- [2.2.1 `config/server.js`](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#1y0m1f)
- [2.2.2 `app/modules/App/global.js`](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#ba0dv8)
- [3. 资源版本](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#906vs6)
- [3.1 天舟云配置系统依赖资源版本列表](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#anpshy)
- [3.2 天舟云预览系统或接入业务系统依赖资源版本列表](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#9jgftt)
- [4. 注意事项](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#246bvp)
- [4.1 业务系统](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#8s1f83)
- [4.1.1 共享依赖](https://docs.cvte.com/docs/tzv16/tzv16-fe-1.9.0#3nlq0g)
...
lcp.common.server = https://lcptest.gz.cvte.cn #需改为本业务域下天舟云的api地址host，须根据不同环境更改地址
```
...
| 4 | 数据源管理 | cir-multiple-data-source | **1.0.4** |
...
| 13 | 低代码页面模版渲染引擎 | cir-csb-common-view | **1.0.15** |
| 14 | 低代码表单业务渲染引擎 | cir-csb-generator | **1.1.26** |
| 15 | 低代码表单渲染引擎 | cir-form-generator | **1.0.14** |
| 16 | 低代码高级列表渲染引擎 | cir-page-generator | **1.0.15** |
| 17 | 路由控制器 | cir-csb-router | 1.0.3 |
| 18 | 动态表单 | cir-dynamic-modal | 1.0.7 |
| 19 | 视图渲染引擎 | viewTable | **1.0.9** |
| 20 | 字典管理模块 | cir-dictionary | 1.0.4 |
| 21 | 数据图表模块 | cir-datart | 1.0.0 |
| 22 | 页面渲染器 | cir-page-engine | **1.0.0** |
| 23 | 数据图表模块 | wuli-charts | **1.0.0** |
| 24 | 高级列表组件库 | lcp-page-components | **1.0.0** |
| 25 | 表单组件库 | lcp-form-components | **1.0.0** |
...
| 2 | 低代码页面模版渲染引擎 | cir-csb-common-view | **1.0.15** |
| 3 | 低代码表单业务渲染引擎 | cir-csb-generator | **1.1.26** |
| 4 | 低代码表单渲染引擎 | cir-form-generator | **1.0.14** |
| 5 | 低代码高级列表渲染引擎 | cir-page-generator | **1.0.15** |
| 6 | 视图渲染引擎 | viewTable | **1.0.9** |
| 7 | 动态表单 | cir-dynamic-modal | 1.0.7 |
| 8 | 全局跳转方法 | csbResource | 1.0.7 |
| 9 | 路由控制器 | cir-csb-router | 1.0.3 |
| 10 | 高级列表设计器 | cir-page-view | **1.0.3** |
| 11 | 页面渲染器 | cir-page-engine | **1.0.0** |
| 12 | 高级列表组件库 | lcp-page-components | **1.0.0** |
| 13 | 表单组件库 | lcp-form-components | **1.0.0** |
