...
source: MinDoc
project_name: TZDOC
source_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1fsu0ob16d6ur
normalized_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1fsu0ob16d6ur
url_hash: 8a37c6b06d67
document_key: TZDOC_8a37c6b06d67
doc_id: tzdoc_v2-1fsu0ob16d6ur
title: 批量提交 (创建人操作)
md_hash: b73f2adffa726965
version: 1728372939
image_count: 0
...
| 参数 | 描述 | 类型 | 可否为空 | 备注说明 |
| --- | --- | --- | --- | --- |
| approveCode | 操作编码 | 字符串(String) | 不可为空 | 固定 submit |
