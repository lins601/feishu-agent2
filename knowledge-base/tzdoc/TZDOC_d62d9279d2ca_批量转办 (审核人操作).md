...
source: MinDoc
project_name: TZDOC
source_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1frfq8dj2s9g5
normalized_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1frfq8dj2s9g5
url_hash: d62d9279d2ca
document_key: TZDOC_d62d9279d2ca
doc_id: tzdoc_v2-1frfq8dj2s9g5
title: 批量转办 (审核人操作)
md_hash: f9d804974c6c6158
version: 1728373110
image_count: 0
...
| 参数 | 描述 | 类型 | 可否为空 | 备注说明 |
| --- | --- | --- | --- | --- |
| approveCode | 操作编码 | 字符串(String) | 不可为空 | 固定 handler_commission |
...
[
    {
        ...
        "comment": "同意",
        "toUserName": "叶端旺",
        "approveCode": "handler_commission",
        "approveName": "转办",
