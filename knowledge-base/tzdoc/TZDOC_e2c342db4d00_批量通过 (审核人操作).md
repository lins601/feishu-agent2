...
source: MinDoc
project_name: TZDOC
source_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1frf84hkvso4a
normalized_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1frf84hkvso4a
url_hash: e2c342db4d00
document_key: TZDOC_e2c342db4d00
doc_id: tzdoc_v2-1frf84hkvso4a
title: 批量通过 (审核人操作)
md_hash: 9310a092ac9c493d
version: 1728373106
image_count: 0
crawled_at: 2026-06-11 16:11:06
---
...
| 参数 | 描述 | 类型 | 可否为空 | 备注说明 |
| --- | --- | --- | --- | --- |
| approveCode | 操作编码 | 字符串(String) | 不可为空 | 固定 sys_inner_pass |
