...
source: MinDoc
project_name: TZDOC
source_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1h0ruhe6qibhh
normalized_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1h0ruhe6qibhh
url_hash: 99ddba909e55
document_key: TZDOC_99ddba909e55
doc_id: tzdoc_v2-1h0ruhe6qibhh
title: 批量终审通过(特权人)
md_hash: 545e5bab67aa5bc9
version: 1766394805
image_count: 0
...
| 参数 | 描述 | 类型 | 可否为空 | 备注说明 |
| --- | --- | --- | --- | --- |
| approveCode | 操作编码 | 字符串(String) | 不可为空 | 固定 admin_finish |
