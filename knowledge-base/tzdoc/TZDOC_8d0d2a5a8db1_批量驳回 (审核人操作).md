...
source: MinDoc
project_name: TZDOC
source_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1fsu0vi921tih
normalized_url: https://docs.cvte.com/docs/tzdoc_v2/tzdoc_v2-1fsu0vi921tih
url_hash: 8d0d2a5a8db1
document_key: TZDOC_8d0d2a5a8db1
doc_id: tzdoc_v2-1fsu0vi921tih
title: 批量驳回 (审核人操作)
md_hash: 17cc83d6606c7e54
version: 1728373121
image_count: 0
crawled_at: 2026-06-11 16:11:07
---
...
| 参数 | 描述 | 类型 | 可否为空 | 备注说明 |
| --- | --- | --- | --- | --- |
| approveCode | 操作编码 | 字符串(String) | 不可为空 | 固定 handler_refuse |
| classId | 表单id | 字符串(String) | 不可为空 | obj_class表的id |
| formInstanceId | 单据id | 字符串(String) | 不可为空 | 业务表中的单据id |
| nodeCode | 当前操作节点编码 | 字符串(String) | 不可为空 |  |
| toNodeCode | 驳回目标节点编码 | 字符串(String) | 不可为空 |  |
| toNodeName | 驳回目标节点名称 | 字符串(String) | 不可为空 |  |
